...
\item [Couplingcut] [Value in cm$^{-1}$ below which the couplings are neglected, default 0, only used in the Coupling propagation scheme. NOTE that this approximation is NOT applied during t$_2$ for two-dimensional spectroscopic calculations and it is not used for the Analysis of the Hamiltonian. If you need to neglect couplings for such calculations you need to set the couplings to zero in the Hamiltonian file.]
