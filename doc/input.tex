...
The first number in the file is the number of sites to shift followed by lines with site index (starting from 0), scaling factor, and shift in cm$^{-1}$. This file is only used if the keyword SingeShiftfile is included in the input.)
