...
In a file named \ilc{Av\_Hamiltonian.txt} the average Hamiltonian is stored as a single snapshot in the GROASC format.
...
The techniques \ilo{CG$\_$2DES$\_$window$\_$SE}, \ilo{CG$\_$2DES$\_$window$\_$GB}, and \ilo{CG$\_$2DES$\_$window$\_$EA} provide these window functions separately.
