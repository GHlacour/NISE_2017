...
\section{MCFRET}
The MCFRET part calculates the Excitation Energy Transfer (EET) rate with Multichromophoric Förster Resonance Energy Transfer (MC-FRET) method.\cite{Jang.2004.Phys.Rev.Lett..92.218301a,Jang.2007.J.Phys.Chem.B.111.6807,zhong2023efficient} The rate is calculated based on the equation:
