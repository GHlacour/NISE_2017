...
A more extensive set of tutorials can be found at \url{https://github.com/GHlacour/NISE\_Tutorials}. This include examples for the LH2 light-harvesting system.
