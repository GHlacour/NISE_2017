...
/*                if (non->propagation == 0) {
        ...
        if ((!strcmp(non->technique, "EAIR")) || (!strcmp(non->technique, "2DIR"))) {
            ...
            for (int t3 = 0; t3 < non->tmax3; t3++) {
                ...
                /* Call subsrotine for all double propagations */
                propagate_double_2DIR_control(non,Hamil_i_e,ft1r,ft1i,fr,fi,rightrr,rightri,
                                  rightnr,rightni,currentSample,molPol,t3,Anh);
